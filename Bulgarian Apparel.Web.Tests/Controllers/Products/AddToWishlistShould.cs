...
{
    [TestClass]
    public class AddToWishlistShould
    {
        [TestInitialize]
        ...
        public void ReturnErrorPage_WhenPassedIdIsNull()
        {
            ...
            // Act & Assert
            controller
                .WithCallTo(c => c.AddToWishlist(null))
        ...
        public void ReturnErrorPage_WhenPassedIdProductIsNotFound()
        {
            ...
            Mock.Arrange(() => productsServiceMock.GetByStringId(productId.ToString())).Returns(list.AsQueryable).MustBeCalled();
            Mock.Arrange(() => usersServiceMock.GetAll()).Returns(ulist.AsQueryable).MustBeCalled();

            // Act
            controller.AddToWishlist(productId.ToString());

            // Act 
            controller
                .WithCallTo(c => c.AddToWishlist(productId.ToString()))
